...
type TDropdownMenuItemProps = React.ComponentProps<
...
const DropdownMenuItem: FC<TDropdownMenuItemProps> = (props): ReactElement => {
...
type TDropdownMenuLabelProps = React.ComponentProps<
	typeof DropdownMenuPrimitive.Label
> & {
	inset?: boolean;
};

const DropdownMenuLabel: FC<TDropdownMenuLabelProps> = (
	props,
): ReactElement => {
...
const DropdownMenuShortcut: FC<React.ComponentProps<"span">> = (
	props,
): ReactElement => {
	const { className, ...rest } = props;
...
const DropdownMenuSubTrigger: FC<TDropdownMenuSubTriggerProps> = (
	props,
): ReactElement => {
