...
export const Textarea: FC<TTextareaProps> = (props): ReactElement => {
	...
	return (
		<textarea
			className={cn(
				"min-h-24 w-full rounded-md border border-neutral-300 bg-white px-3 py-2 text-sm outline-none focus:border-neutral-900 disabled:cursor-not-allowed disabled:opacity-50",
				className,
			)}
			{...rest}
		/>
